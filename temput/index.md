...
Miki osaa tällä hetkellä 65 käskyä tai temppua ja 10 uutta käskyä tai temppua on työn alla. 9 kuulostaa paljolta, mutta tässä on mukana useita "siepattavia" toimintoja (kuten turkin ravistelu, selällään makaaminen ja seisominen) joten ei auta kuin odottaa sieppailtavia tilanteita.
