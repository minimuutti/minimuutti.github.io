...
Miki osaa tällä hetkellä 63 käskyä tai temppua ja 11 uutta käskyä tai temppua on työn alla. 11 kuulostaa paljolta, mutta tässä on mukana useita "siepattavia" toimintoja (kuten turkin ravistelu, selällään makaaminen ja seisominen) joten ei auta kuin odottaa sieppailtavia tilanteita.
