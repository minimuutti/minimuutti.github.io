...
Miki osaa tällä hetkellä 59 käskyä tai temppua ja 14 uutta käskyä tai temppua on työn alla. 14 kuulostaa paljolta, mutta tässä on mukana useita ”siepattavia” toimintoja (kuten turkin ravistelu, selällään makaaminen ja seisominen) joten ei auta kuin odottaa sieppailtavia tilanteita.
